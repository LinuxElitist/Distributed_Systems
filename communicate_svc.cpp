...
static void
publish_subscribe_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
...
main (int argc, char **argv)
{
	...
	pmap_unset (PUBLISH_SUBSCRIBE_PROG, PUBLISH_SUBSCRIBE_VERS);
	...
	if (!svc_register(transp, PUBLISH_SUBSCRIBE_PROG, PUBLISH_SUBSCRIBE_VERS, publish_subscribe_prog_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (PUBLISH_SUBSCRIBE_PROG, PUBLISH_SUBSCRIBE_VERS, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, PUBLISH_SUBSCRIBE_PROG, PUBLISH_SUBSCRIBE_VERS, publish_subscribe_prog_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (PUBLISH_SUBSCRIBE_PROG, PUBLISH_SUBSCRIBE_VERS, tcp).");
		exit(1);
	}
